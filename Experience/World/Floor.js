...
export default class Floor {
    ...
    setCircles() {
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0x9EBBE7 });
        const material2 = new THREE.MeshStandardMaterial({ color: 0x3A606E });
        const material3 = new THREE.MeshStandardMaterial({ color: 0x607B7D });
